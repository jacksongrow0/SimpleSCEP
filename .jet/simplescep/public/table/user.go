...
func newUserTableImpl(schemaName, tableName, alias string) userTable {
	var (
		...
		allColumns           = postgres.ColumnList{IDColumn, OrganizationIDColumn, EmailColumn, NameColumn, RoleColumn}
		mutableColumns       = postgres.ColumnList{OrganizationIDColumn, EmailColumn, NameColumn, RoleColumn}
